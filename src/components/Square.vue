...
<template>
    <div
    :class="{
        'w-6/12 overflow-auto bg-transparent border-4 rounded-xl self-center -mt-5':true,
        ...
        <div class="text-black p-4 ml-6 mt-6 max-w-xl">
        <h2 class="flex text-4xl font-bold"><slot name="normalHeading"></slot><p :class="{
